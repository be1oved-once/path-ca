(function () {
  ...
  /* ── Inject Poppins font once, for every page that loads common-layout ── */
  (function injectPoppins() {
    if (document.getElementById('poppins-font')) return; // already injected
    // preconnects
...
Built for serious exam practice, smart evaluation, and real results.
  ...
  <div class="footer-bottom">
    © 2026 PathCA · All rights reserved
  </div>
</footer>
